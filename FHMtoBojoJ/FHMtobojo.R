...
player_goalie_rs <- subset(player_goalie_rs, select = -c(TeamId))
names(player_goalie_rs)[names(player_goalie_rs) == "TeamID"] <- "TeamId"
...
player_goalie_po <- subset(player_goalie_po, select = -c(TeamId))
names(player_goalie_po)[names(player_goalie_po) == "TeamID"] <- "TeamId"
...
names(player_skater_po)[names(player_skater_po) == "Last Name"] <- "Name"
names(player_skater_po)[names(player_skater_po) == "TeamID"] <- "TeamId"


player_skater_po$LeagueId <- c(2) 
...
write.csv(SkatersCombined,"C:\\Users\\Luke\\Desktop\\SHL\\S57SkatersJunior.csv")
write.csv(GoaliesCombined,"C:\\Users\\Luke\\Desktop\\SHL\\S57goalieJunior.csv")
